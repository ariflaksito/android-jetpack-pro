...
import static net.ariflaksito.mymovie.data.source.remote.StatusResponse.EMPTY;
import static net.ariflaksito.mymovie.data.source.remote.StatusResponse.ERROR;
import static net.ariflaksito.mymovie.data.source.remote.StatusResponse.SUCCESS;
